...
import com.ekarantechnologies.wandi.adapters.vpageradapter;
import com.ekarantechnologies.wandi.databinding.FragmentDashboardBinding;
        ...
        TabLayoutMediator tabLayoutMediator=new TabLayoutMediator(binding.tablayout, binding.viewPager, new TabLayoutMediator.TabConfigurationStrategy() {
            ...
            public void onConfigureTab(@NonNull TabLayout.Tab tab, int position) {
                switch (position){
                    case 0:{
                        tab.setText("Music");
                        tab.setIcon(R.drawable.ic_baseline_headset_24);
                        break;
                    }
                    case 1:{
                        tab.setText("Artist");
                    ...
                    case 2:{
                        tab.setText("Folders");
                        tab.setIcon(R.drawable.ic_baseline_folder_open_24);
                        break;
                    }
                }
            }
