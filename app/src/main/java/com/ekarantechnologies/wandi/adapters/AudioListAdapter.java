...
import com.ekarantechnologies.wandi.databinding.ItemAudioBinding;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        Holder.binding.shareaudio.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                File filelocation = new File(Environment.getExternalStorageDirectory() + File.separator + "worship/",filename);
                Uri path = FileProvider.getUriForFile(context, "com.ekarantechnologies.wandi.fileprovider", filelocation);
