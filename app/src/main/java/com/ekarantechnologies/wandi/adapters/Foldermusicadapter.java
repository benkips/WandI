...
public class Foldermusicadapter extends PagedListAdapter<Mydatamusicfolder, RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof MusicHolder) {
            Mydatamusicfolder mydata = getItem(position);
            if (mydata != null) {
                ...
                Holder.binding.cv.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        bundle.putString("table","folders");
                        Navigation.findNavController(view).navigate(R.id.action_musicfromfolder_to_playmusic, bundle);
    ...
    private static DiffUtil.ItemCallback<Mydatamusicfolder> Diff_callback = new DiffUtil.ItemCallback<Mydatamusicfolder>() {
        @Override
        public boolean areItemsTheSame(@NonNull Mydatamusicfolder oldItem, @NonNull Mydatamusicfolder newItem) {
            return oldItem.id == newItem.id;
        }

        @Override
        public boolean areContentsTheSame(@NonNull Mydatamusicfolder oldItem, @NonNull Mydatamusicfolder newItem) {
