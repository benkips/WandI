...
import com.ekarantechnologies.wandi.fragments.Dashboard;
import com.ekarantechnologies.wandi.models.Mydatamusic;

public class Musicadapter extends PagedListAdapter<Mydatamusic,RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if(holder instanceof MusicHolder) {
            Mydatamusic mydata=getItem(position);
            if(mydata!=null){
                ...
                Holder.binding.cv.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        bundle.putString("table","songs");
                        Navigation.findNavController(view).navigate(R.id.action_dashboard_to_playmusic,bundle);
    ...
    private  static DiffUtil.ItemCallback<Mydatamusic> Diff_callback=new DiffUtil.ItemCallback<Mydatamusic>() {
        @Override
        public boolean areItemsTheSame(@NonNull Mydatamusic oldItem, @NonNull Mydatamusic newItem) {
            return oldItem.id == newItem.id;
        }

        @Override
        public boolean areContentsTheSame(@NonNull Mydatamusic oldItem, @NonNull Mydatamusic newItem) {
